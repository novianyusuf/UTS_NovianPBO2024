...
<body>
    ...
    <div class="content">
        <header class="py-5 text-center">
            <div class="container">
                <h1 class="display-5 fw-bold">Data Sepatu</h1>
            </div>
        </header>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_data.php?id=<?= $row["id_produk"]; ?>" class="btn btn-edit btn-sm">Edit</a>
                                            <a href="delete_data.php?id=<?= $row["id_produk"]; ?>" class="btn btn-delete btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
